export function Card({
  ...
  return (
    <article className='rounded-3xl max-w-5xl items-center flex flex-col gap-8 bg-[#48e2] backdrop-blur-2xl p-8 md:flex-row md:justify-evenly md:px-14 md:py-15'>
